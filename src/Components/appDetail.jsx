...
import { countries } from '../redux/data/covidData';
...
export default function AppDetails() {
  ...
  const states = (country.regions.length > 0
    ...
    : (
      <div className="bg-blue1 text-white d-flex align-items-center p-2">
    ...
    <>
      <div className="pt-3 bg-pink2">
        <Row className="m-0">
          ...
          <Col xs={6} sm={6} md={6} className="p-0 text-white d-flex flex-column justify-content-center align-items-end pe-4">
